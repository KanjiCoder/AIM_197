...
//:CONFIGURATION:[109]:======================================:// // [---]
    ...
    var   d_tileboi_log_put =( 1 ); /** Log Put Tile?   **/      // [197]
                                                                 // [---]
//:======================================:CONFIGURATION:[109]:// // [---]
//:SYSTEM_INDEX:[102]:=======================================:// // [---]
/** ******************************************************** *** // [102]
    ...
    ARTGIRL [C:05] [D:04] : Render Pipeline Management           // [102]
    CAMERAH [C:09] [D:05] : Manipulates vp0 & vp1                // [109]
    SEXYCAM [C:10] [D:06] : SexyCam === Hot Key Snapping Camera  // [125]
    ASERVER [C:01] [D:07] : Server Side Functions Only           // [102]
    DABITCH [C:02] [D:08] : Database Access Functions Only       // [102]
    EDIGAME [C:08] [D:09] : Editor State + Game State            // [102]
    KONAMIC [C:14] [D:10] : Konami Code Debugger                 // [180]
    KEYMAST [C:03] [D:11] : Keyboard Listeners                   // [102]
    MOUMAST [C:11] [D:12] : Mouse Master (Mouse Listeners)       // [142]
    SERGAME [C:06] [D:13] : HIGH_LEVEL_GAME_CODE - Server Side   // [102]
...
//:TOP_LEVEL_LOOKUP_TABLES:[128]:============================://
    ...
    const d_hi9_mmi = "[LOOKUP_NOT_NEEDED_AT_THIS_TIME]" ;       // [163]
...
//:MONKEY_WRENCH_MACROS:[108]:===============================://
    ...
    const d_g25_rdy = "[USE:g25_r4y]" ;                          // [163]
                                                                 // [163]
    const d_hi8_mmc =( "[USE:d_hi9_mmi:(mmc_is_a_const)]"   );   // [163]
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::// // [148]
        ...
        //: SEE[ #_FSM_EXPLAINED_# ]://                          // [148]
                                                                 // [148]
        const c_artgirl_fsm_bad =(  0  );  //: INVALID   ://     // [148]
        const c_artgirl_fsm_nil =(  1  );  //: NOT_SET   ://     // [148]
...
//: __KONAMIC__ V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V_V:// // [180]
    ...
    const c_konamic_dumones =( 2 ); //:Fill Dum With Binary 1:// // [180]
    const c_konamic_dumzero =( 3 ); //:Fill Dum With Binary 0:// // [180]
...
(c_artgirl_wgl_tag+`                                             // [074]   
    ...
    //:#_R4_ENUMS_#:[176]:-----------------------------------:// // [176]
        ...
        #define r4y_3 U32( ${r4y_3} )                            // [176]
                                                                 // [176]
    //:-----------------------------------:#_R4_ENUMS_#:[176]:// // [176]
    //:#_G25_R4C_TABLES_#:[176]:-----------------------------:// // [176]
    #define _ U32( 0xFFFFFFFF )                                  // [176]
                                                                 // [176]
        U32 d_g25_r4x[ 25 ]=U32[ 25 ](                           // [176]
                                                                 // [176]
            (  _  ),(  _  ),(r4x_0),(  _  ),(  _  )              // [176](163)
        ,   (  _  ),(r4x_1),(r4x_2),(r4x_3),(  _  )              // [176](163)
        ,   (r4x_0),(r4x_1),(r4x_2),(r4x_3),(r4x_0)              // [176](163)
        ,   (  _  ),(r4x_1),(r4x_2),(r4x_3),(  _  )              // [176](163)
        ,   (  _  ),(  _  ),(r4x_0),(  _  ),(  _  )              // [176](163)
                                                                 // [176]
        );//:@NESC@://                                           // [176]
        ...
        ,   (  _  ),(r4y_0),(r4y_0),(r4y_0),(  _  )              // [176](163)
        ,   (r4y_1),(r4y_1),(r4y_1),(r4y_1),(r4y_2)              // [176](163)
        ,   (  _  ),(r4y_2),(r4y_2),(r4y_2),(  _  )              // [176](163)
        ,   (  _  ),(  _  ),(r4y_3),(  _  ),(  _  )              // [176](163)
                                                                 // [176]
        );//:@NESC@://                                           // [176]
    #undef _                                                     // [176]
    //:-----------------------------:#_G25_R4C_TABLES_#:[176]:// // [---]
    ...
    //:             : THUS[ GET_LA3_FV4 ]                ://     //      [175]
                                                                 //      [175]
    #define GET_UV3_P2K "[I_TAKE_IT_BACK!]"  //: @M_W_M@ ://     //      [175]
    #define GET_P2K_FV4 "[FIX:GET_LA3_FV4]"  //: @M_W_M@ ://     //      [175]
    #define GET_FV4_P2K "[FIX:GET_LA3_FV4]"  //: @M_W_M@ ://     //      [175]
    #define GET_FV4_LA3 "[FIX:GET_LA3_FV4]"  //: @M_W_M@ ://     //      [175]
                                                                 // [---][---]
...
if( /** __PIX2048__ **/ notnode ){                               // [185][MOV][156]
    ...
    var d_pix0512 = new Uint8Array( 4 *  512 *  512 );           // [185][MOV][156]
                                                                 // [185][MOV][---]
...
if( /** __ARTGIRL__ **/ notnode ){                               // [063] 
    ...
    let max =( 1 ) ; //:Max Texture Coordinate Value://          // [083]
                                                                 // [---]
    var d_artgirl_p2k_tex = "[nil][d_artgirl_p2k_tex]"  ;        // [173]
...
if( /** __EDIGAME__ **/ notnode ){                               // [102]
    ...
    ,   edi_la3 :(      1)  //: LAY[0==TIL,1==BOM,2==FAD]://     // [170]
    ,   edi_v16 :(     13)  //: TIL_VAL[ 0 -to- (16-1) ] ://     // [170]
                                                                 // [---]
...
if( /** __KONAMIC__ **/ notnode ){ //:::::BEG[ KONAMIC_DATA ]:// // [180]
    ...
    ,   c_konamic_dumzero //: ( "B" / 1 ) ://                    // [180]
                                                                 // [180]
    ,   c_konamic_nothing //: ( "C" / 2 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "D" / 3 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "E" / 4 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "F" / 5 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "G" / 6 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "H" / 7 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "I" / 8 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "J" / 9 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "K" /10 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "L" /11 ) ://                    // [180]
    ...
    ,   c_konamic_nothing //: ( "R" /17 ) ://                    // [180]
    ,   c_konamic_nothing //: ( "S" /18 ) ://                    // [180]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|//
    ...
    PRIVATE_F_ARTGIRL_TEX_PUT(  //:::::::::::::::::::::::://     // [174]
        ...
        //:[ATF]:#_F_ARTGIRL_TEX_PUT_#:[ATF]:::::::::::::://     // [174]
        //:WEBGL_REFRESHER_SEE[ #_WEB_GL_DEFINITIONS_# ]:://     // [174]
                                                                 // [174]
        let wgl = d_artgirl.wgl     ; //:WebGlContext  ::://     // [174]
        let t_s = c_artgirl_p2k_lot ; //:TextureSlot   ::://     // [174]
        let t_h = d_artgirl_p2k_tex ; //:TextureHandle ::://     // [174]
                                                                 // [174]
        ASS( t_s >=  (0) , "[SAME_VALUE_AS::::d_p2k]" );         // [174]
        ASS( t_h != null , "[Its_An_Object_In_WEBGL]" );         // [174]
                                                                 // [174]
        //: #_ACTIVE_TEXTURE____VS____BIND_TEXTURE_# ://         // [174]
                                                                 // [174]
        wgl.activeTexture( wgl.TEXTURE0   + t_s ); //::::://     // [174]
        wgl.bindTexture(   wgl.TEXTURE_2D , t_h ); //::::://     // [174]
                                                                 // [174]
        let t2d = wgl.TEXTURE_2D        ; //: t_2d    :::://     // [174]
        let _n_ = wgl.NEAREST           ; //: near    :::://     // [174]
        let _e_ = wgl.CLAMP_TO_EDGE     ; //: edge    :::://     // [174]
        let min = wgl.TEXTURE_MIN_FILTER; //: min_fil :::://     // [174]
        let mag = wgl.TEXTURE_MAG_FILTER; //: mag_fil :::://     // [174]
        let _s_ = wgl.TEXTURE_WRAP_S    ; //: twrap_s :::://     // [174]
        let _t_ = wgl.TEXTURE_WRAP_T    ; //: twrap_t :::://     // [174]
                                                                 // [174]
        wgl.texParameteri( t2d, min , _n_ ); //::::::::::://     // [174]
        wgl.texParameteri( t2d, mag , _n_ ); //::::::::::://     // [174]
        ...
        wgl.pixelStorei(wgl.UNPACK_ALIGNMENT, ALN);              // [174]
                                                                 // [174]
        let pix_wid =(      2048 ); //:FOR_TEXTURE_UPLOAD://     // [174]
        let pix_hig =(      2048 ); //:FOR_TEXTURE_UPLOAD://     // [174]
        let pix_arr =( d_pix2048 ); //:FOR_TEXTURE_UPLOAD://     // [174]
                                                                 // [174]
        //:SEE[ #_TEX_IMAGE_2D_NOTES_TXT_# ]:::::::::::::://     // [174]
        wgl.texImage2D(  //:-----------------------------://     // [174]
            wgl.TEXTURE_2D       //: TARGET              ://     // [174]
        ,   0                    //: LEVEL               ://     // [174]
        ,   wgl.RGBA8UI          //:#INTERNAL_FORMAT#    ://     // [174]
            //:------------------------------------------://     // [174]
        ,   pix_wid              //: WIDTH  / PIX_WID    ://     // [174]
        ,   pix_hig              //: HEIGHT / PIX_HIG    ://     // [174]
        ,   0                    //: BORDER              ://     // [174]
            //:------------------------------------------://     // [174]
        ,   wgl.RGBA_INTEGER     //:#SOURCE_FORMAT#      ://     // [174]
        ,   wgl.UNSIGNED_BYTE    //:#SOURCE_TYPE#        ://     // [174]
        ,   pix_arr              //: ARRAY_BUFFER_VIEW   ://     // [174]
        );; //:------------------------------------------://     // [174]
                                                                 // [174]
        MSG( "[P_I_X_2_0_4_8:PUSH_AFTER_RPL]" ); //::::::://     // [174]
                                                                 // [174]
        //:#_TOO_MANY_COIN_FLIPS_2022_#:[174]:-----------://     // [174]
        //:Download_Uploaded_Texture_Check:[174]:--------://     // [174]
        if( d_bug >= 1 ){                                        // [174]
                                                                 // [174]
            MSG( "[TODO:PARANOID_SANITY_CHECK]" );               // [174]
                                                                 // [174]
        };;                                                      // [174]
        //:--------:Download_Uploaded_Texture_Check:[174]://     // [174]
        //:-----------:#_TOO_MANY_COIN_FLIPS_2022_#:[174]://     // [174]
                                                                 // [174]
    };; //:ENDFUNC[ F_ARTGIRL_TEX_PUT ]::::::::::::::::::://     // [174]
    ...
    PRIVATE_F_ARTGIRL_UNI_PUT(                                   //      [121]
        ...
        wgl.uniform1ui(      d_dmx_loc , d_dmx     );            // [157][141]
        wgl.uniform1ui(      d_dmy_loc , d_dmy     );            // [157][141]
        wgl.uniform1ui(      d_gtx_loc , d_gtx     );            // [157][150]
        wgl.uniform1ui(      d_gty_loc , d_gty     );            // [157][150]
        wgl.uniform1ui(      d_te7_loc , d_te7     );            //      [150]
        wgl.uniform1i(       d_p2k_loc ,   p2k     ); //:@CB@:// // [173]
    };;                                                          // [---][121]
    ...
    PRIVATE_F_ARTGIRL_RPL( //:Render Pipeline Load @RPL@ ://    // [068] 
        ...
        //:LIKE_AND_SUBSCRIBE_YOU_FREELOADER:[082]:------://    //      [082]
            ...
            if( NIL( wgl ) ){                                   //      [082]
                ...
                F_ARTGIRL_TEX_PUT();  //:PUT_ONTO_GPU://        // [174]
                                                                // [---]
            };;                                                 //      [082]
        //:------:LIKE_AND_SUBSCRIBE_YOU_FREELOADER:[082]://    //      [082]
    ...
    PRIVATE_F_ARTGIRL_TIK(                                      //      [063] 
        ...
        //:update_texture_if_needed:[184]:---------------://    // [184]
                                                                // [184]
            if( d_pix2048_dir >= 1 ){                           // [184]
                d_pix2048_dir =( 0 );                           // [184]
                                                                // [184]
                F_ARTGIRL_TEX_PUT( );                           // [184]
            };;                                                 // [184]
        //:---------------:update_texture_if_needed:[184]://    // [184]
    ...
    PRIVATE_F_ARTGIRL_INI(  /**AKA[ render pipeline factory ]**/ // [071] 
        ...
        //:d_pix2048__gpu_side_texture:[173]:------------://     // [---]

            d_artgirl_p2k_tex = a_g.wgl.createTexture();         // [173]
        ...
        if( d_konamic_act >= 1 /** Konami code Active ? **/ ){   //      [181]
            ...
            if( k26_has ){                                       // [182]
                ...
                if( c_konamic_dumones === enuproc ){             // [182]
                                                                 // [---]
                    F_PIX2048_H3X_H3Y_U32(0,0,0xFFFFFFFF);       // [186]
                    F_PIX2048_H3X_H3Y_U32(1,0,0xFFFFFFFF);       // [186]
                    F_PIX2048_H3X_H3Y_U32(2,0,0xFFFFFFFF);       // [186]
                                                                 // [186]
                    F_PIX2048_H3X_H3Y_U32(0,1,0xFFFFFFFF);       // [186]
                    F_PIX2048_H3X_H3Y_U32(1,1,0xFFFFFFFF);       // [186]
                    F_PIX2048_H3X_H3Y_U32(2,1,0xFFFFFFFF);       // [186]
                                                                 // [186]
                    F_PIX2048_H3X_H3Y_U32(0,2,0xFFFFFFFF);       // [186]
                    F_PIX2048_H3X_H3Y_U32(1,2,0xFFFFFFFF);       // [186]
                    F_PIX2048_H3X_H3Y_U32(2,2,0xFFFFFFFF);       // [186]
                                                                 // [186]
                    MSG( "[DONE:c_konamic_dumones]" );           // [186]
                                                                 // [---]
                }else                                            // [182]
                if( c_konamic_dumzero === enuproc ){             // [182]
                                                                 // [---]
                    F_PIX2048_H3X_H3Y_U32(0,0,0x00000000);       // [186]
                    F_PIX2048_H3X_H3Y_U32(1,0,0x00000000);       // [186]
                    F_PIX2048_H3X_H3Y_U32(2,0,0x00000000);       // [186]
                                                                 // [186]
                    F_PIX2048_H3X_H3Y_U32(0,1,0x00000000);       // [186]
                    F_PIX2048_H3X_H3Y_U32(1,1,0x00000000);       // [186]
                    F_PIX2048_H3X_H3Y_U32(2,1,0x00000000);       // [186]
                                                                 // [186]
                    F_PIX2048_H3X_H3Y_U32(0,2,0x00000000);       // [186]
                    F_PIX2048_H3X_H3Y_U32(1,2,0x00000000);       // [186]
                    F_PIX2048_H3X_H3Y_U32(2,2,0x00000000);       // [186]
                                                                 // [186]
                    MSG( "[DONE:c_konamic_dumzero]" );           // [186]
                                                                 // [---]
                }else                                            // [182]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [---][???]
    ...
    PRIVATE_F_KEYMAST_DOW_EDI(                                   // [104]
        ...
        &&  i_evt_key.keyCode <= 105  //:numpad9://              // [105]
            ...
            let k_c =( i_evt_key.keyCode );                      // [131]
            pad_num=( k_c - 96 );                                // [131][105]
            LOG( "[NUMPAD_KEYCODE]:" , k_c     );                // [131]
            LOG( "[NUMPAD_PAD_NUM]:" , pad_num );                // [131]
        };;                                                      // [105]
    ...
    PRIVATE_F_KEYMAST_DOW(                                       // [057] 
        ...
        F_KONAMIC_EVT_KEY( i_evt_key );                          // [181]
...
//|--|--|--|--|--|--|--|--|--|SUBS|--|--|--|--|--|--|--|--|--|// // [142]
    ...
    const   F_MOUMAST_FUP = function                             // [169]
